...
Home.displayLogo = function(){
    Home.logo = game.add.text(0, 20, 'CYBERIA', { font: "80px Impact", fill: "#f1c40f", stroke: "#c0392b", strokeThickness: 10, shadowOffsetX: 5, shadowOffsetY: 5, shadowColor: "rgba(0,0,0,0.5)", shadowBlur: 5 });
